...
def _unittest_define() -> None:
    ...
    assert d.file_path == Path(_DIRECTORY.name, "uavcan", "test", "5000.Message.1.2.uavcan")
    assert d.root_namespace_path == Path(_DIRECTORY.name, "uavcan")
    ...
    assert d.file_path == Path(_DIRECTORY.name, "uavcan", "Service.255.254.uavcan")
    assert d.root_namespace_path == Path(_DIRECTORY.name, "uavcan")
